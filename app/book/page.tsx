        ...
        <main className="min-h-screen" style={{ background: "var(--bg)" }}>
            ...
            <section className="relative pt-32 pb-12 px-4 overflow-hidden bg-[var(--section-dark)] text-white text-center">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-5xl font-serif font-bold">Book Your Spiritual Journey</h1>
                    <p className="text-white/70 mt-3">Fill in the details below and we will contact you shortly.</p>
                </motion.div>
            </section>
                            ...
                            {isSubmitted ? (
                                ...
                                >
                                    ...
                                    <p style={{ color: "var(--text-muted)" }}>
                                        Jai Shri Krishna! 🙏 Our team will contact you within 24 hours to confirm your yatra.
                                    </p>
                                    <button
                                ...
                                >
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {[
                                            ...
                                            { label: "Phone Number", name: "phone", type: "tel", placeholder: "+91 73005 48523" },
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            <label className={labelClass} style={{ color: "var(--text-muted)" }}>Number of Travelers</label>
                                            <input
                                                type="number" name="travelers" min="1" required
                                        ...
                                        <div>
                                            <label className={labelClass} style={{ color: "var(--text-muted)" }}>Select Package</label>
                                            <select
                                                name="package" value={formData.package} onChange={handleChange}
                                                className={inputClass}
                                                style={{ background: "var(--input-bg)", border: "1.5px solid var(--input-border)", color: "var(--text)" }}
                                            >
                                                {["Vrindavan Parikrama", "Mathura Janmabhoomi", "Barsana & Nandgaon",
                                                    "Govardhan Parikrama", "Complete Braj Yatra", "Mystery of Nidhivan"].map(opt => (
                                    ...
                                    <div>
                                        <label className={labelClass} style={{ color: "var(--text-muted)" }}>Special Requests</label>
                                        <textarea
                                            name="message" rows={4} value={formData.message} onChange={handleChange}
                                            placeholder="Any specific requirements or group details?"
                                            className={inputClass}
                                            style={{ background: "var(--input-bg)", border: "1.5px solid var(--input-border)", color: "var(--text)", resize: "none" }}
                                        />
                                    </div>
