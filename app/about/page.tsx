...
import {
  Award, Users, Landmark, Heart, Compass, CloudRain,
  Sparkles, Eye, Moon, Flower, Trees, Globe, Bird,
} from "lucide-react";
...
const destinations = [
  {
    title: "Mathura", subtitle: "The Birthplace", spec: "Janmabhoomi",
  ...
  {
    title: "Gokul", subtitle: "The Childhood Abode", spec: "Raman Reti & Nand Bhawan",
    desc: "The sacred village where Lord Krishna spent his infancy. Experience the divine serenity of Raman Reti.",
    icon: <Heart className="text-pink-500" />,
  },
  {
    title: "Nandgaon", subtitle: "The Fortress of Nand Baba", spec: "Nandishwar Temple",
  ...
  {
    title: "Chhatikara", subtitle: "The Divine Gateway", spec: "Garuda Govind Temple",
  ...
  {
    title: "Char Dham", subtitle: "The Universal Confluence", spec: "Srimad Bhagwat Dham",
...
const hiddenTreasures = [
  {
    title: "Nidhivan", tag: "Deep Mystery",
  ...
  {
    title: "Raman Reti", tag: "Divine Play",
  ...
  {
    title: "Seva Kunj", tag: "Sacred Grove",
  ...
  {
    title: "Radha Kund", tag: "Holiest Kund of Braj",
  ...
  {
    title: "Kokilavan", tag: "Ancient Shani Dev Dham",
...
const AboutUsPage = () => {
  return (
    <main className="min-h-screen font-sans" style={{ background: "var(--bg)" }}>
      <Navbar />
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div>
              ...
              <h2 className="text-4xl font-serif font-bold mt-2 mb-3" style={{ color: "var(--text)" }}>
                Our Sacred Mission
              </h2>
            ...
            <p className="text-lg leading-relaxed" style={{ color: "var(--text-muted)" }}>
              At <b className="text-saffron">Braj Path Pradarsak</b>, we believe that a visit to Braj is
              not just a tour, but a homecoming for the soul. Based in the heart of this holy land,
              we act as your <b style={{ color: "var(--text)" }}>Pradarshak</b> (Guide), bridging comfort with spirituality.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { Icon: Award, title: "Authentic Insight", sub: "Real stories & history", bg: "rgba(28,57,187,0.08)", color: "#1c39bb" },
                { Icon: Users, title: "Local Expertise", sub: "Native Brajwasi guides", bg: "rgba(255,153,51,0.08)", color: "#ff9933" },
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl" style={{ border: `4px solid var(--surface)` }}>
              <img src="/kusumsarovar.jpg" alt="Kusum Sarovar" className="w-full h-full object-cover aspect-[4/3]" />
            </div>
            <motion.div
            ...
            >
              ...
              <p className="text-xs opacity-70 uppercase tracking-widest">Years of Heritage</p>
            </motion.div>
          </motion.div>
        </div>
      </section>
      ...
      {/* ── Destinations Grid ── */}
      <section className="py-24 max-w-7xl mx-auto px-6" style={{ background: "var(--bg)" }}>
        <motion.div
          initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeInUp}
        ...
        >
          ...
          <h2 className="text-4xl font-serif font-bold mt-2" style={{ color: "var(--text)" }}>
        ...
        >
          {destinations.map((place, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-1" style={{ color: "var(--text)" }}>{place.title}</h3>
              <p className="text-[10px] font-bold text-saffron uppercase tracking-widest mb-3">{place.spec}</p>
              <p className="text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>{place.desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/20 mb-4">
              ...
              <span className="text-xs font-semibold tracking-widest uppercase text-gold">Secret Spots</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4">Hidden Treasures of Braj</h2>
            <p className="text-blue-100 max-w-2xl mx-auto">
              Beyond the bustling temples lie the silent groves and mystical corners known only to true seekers.
            </p>
          </motion.div>
      ...
      {/* ── CTA ── */}
      <section className="py-24 text-center px-6" style={{ background: "var(--surface-2)" }}>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        >
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4" style={{ color: "var(--text)" }}>
            Ready for your Pilgrimage?
          </h2>
          <p className="mb-10 max-w-xl mx-auto text-lg" style={{ color: "var(--text-muted)" }}>
