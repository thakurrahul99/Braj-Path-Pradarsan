      ...
      <section className="relative h-[70vh] min-h-[480px] overflow-hidden">
            ...
            {pkg.gallery.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 8,
                  background:
                    i === activeGallery ? "#ffd700" : "rgba(255,255,255,0.4)",
                }}
              />
            ))}
          </motion.div>
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 p-8 md:p-12">
          ...
          >
            ...
            <p className="text-white/80 text-lg max-w-2xl italic">
              {pkg.tagline}
            </p>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            >
              ...
              <p
                ...
                style={{ color: "var(--text-muted)" }}
              >
                ✦ All prices are <strong>per person</strong> · Prices vary by
                group size
              </p>
              <div
              ...
              >
                ...
                >
                  ...
                  <span className="flex items-center gap-1.5">
                    <IndianRupee size={12} /> Per Person
                  </span>
                </div>
                {/* Rows */}
            ...
            <motion.section
              ...
              viewport={{ once: true }}
            >
              <SectionTitle icon={<Star size={18} />}>
                Tour Highlights
              </SectionTitle>
                  ...
                  >
                    ...
                    <AnimatePresence>
                      {openDay === i && (
                        ...
                        >
                          <ul
                            className="px-6 pb-5 space-y-2.5 border-t pt-3"
            ...
            {pkg.gallery.length > 1 && (
              <motion.section
                ...
                viewport={{ once: true }}
              >
                <SectionTitle icon={<Camera size={18} />}>
                  Photo Gallery
                </SectionTitle>
          ...
          <div className="lg:col-span-1">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(90deg, #ff9933, #ffd700, #ff9933)",
                }}
              />

              <div className="p-6 space-y-5">
                <div>
                  <p className="text-xs text-saffron font-bold tracking-widest uppercase">
                    Starting From
                  </p>
                ...
                <div className="space-y-3 pt-1">
                  <motion.a
                    href={`https://wa.me/917078117174?text=${encodeURIComponent(whatsappMsg)}`}
                    target="_blank"
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, #ff9933 0%, #ffd700 60%, #ff9933 100%)",
                      backgroundSize: "200%",
