...
export const metadata: Metadata = {
  title: "Braj Darshan Gallery | Mathura Vrindavan Govardhan Photos | Braj Path Pradarshak",
  description:
    "Braj ke sacred places ki stunning photos — Prem Mandir, Banke Bihari, Radha Kund, Govardhan, Barsana aur bahut kuch. Divya Braj Darshan Gallery.",
  openGraph: {
    title: "Braj Darshan Gallery | Braj Path Pradarshak",
    description:
      "Braj ke sacred places ki stunning photos — Prem Mandir, Banke Bihari, Radha Kund, Govardhan, Barsana.",
    url: "https://www.brajpathpradarshak.com/gallery",
