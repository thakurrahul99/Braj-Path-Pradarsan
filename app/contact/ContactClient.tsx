...
const ContactClient = () => {
  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      {/* ── Govardhan Map (SEO: specific location) ── */}
      <section className="max-w-7xl mx-auto px-6 pb-10">
        <motion.div
          ...
          style={{ border: "1px solid var(--border)", marginTop: "2rem" }}
        >
          <div className="px-6 py-4" style={{ background: "var(--surface)" }}>
            <h2 className="text-xl font-serif font-bold" style={{ color: "var(--text)" }}>
              📍 Find Us — Govardhan, Mathura
            </h2>
            <p className="text-sm mt-1" style={{ color: "var(--text-muted)" }}>
              We operate from Govardhan, Uttar Pradesh. Come visit us or get in touch before your yatra.
            </p>
          </div>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3543.5!2d77.4678!3d27.4969!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397377b0e8e2b74d%3A0x6f8b8c8b8c8b8c8b!2sGovardhan%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin"
            width="100%"
            height="350"
            style={{ border: 0, display: "block" }}
            allowFullScreen
            loading="lazy"
            title="Braj Path Pradarshak — Govardhan, Mathura"
          />
        </motion.div>
      </section>

      {/* ── Braj Region Map (existing) ── */}
      <section
